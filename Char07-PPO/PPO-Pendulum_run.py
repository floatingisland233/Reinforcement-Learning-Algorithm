...
# note that in lines 127 and 137, static advantage and value target are used
# if one predicts the advantage and target value using the current critic parameters,
# (i.e., move lines 116-119 inside the update function)
# which may lead to non-stationary problems
    ...
    def update(self):
        ...
        for _ in range(self.ppo_epoch):
            for index in BatchSampler(
                ...
                surr1 = ratio * adv[index] # adv are static as they are determined before the update loop
